...
public class ResourceConfiguration {
	...
	public ResourceService resourceService(ResourceRepository resourceRepository, RestClient.Builder restClientBuilder, DiscoveryClient discoveryClient, S3Service s3s) {
		return new ResourceService(resourceRepository, restClientBuilder, discoveryClient, s3s);
	}
